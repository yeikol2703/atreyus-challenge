...
def _build_prompt(line_items: list[LineItem]) -> str:
    ...
    return (
        "You are a construction materials pricing assistant. "
        "Estimate realistic current market unit prices in USD for each line item below. "
        "Call set_item_price once for every item with its id, a realistic unit_price, "
        "and a brief reasoning explaining your estimate.\n\n"
